...
{
    return new ATKGuitarPreampAudioProcessorEditor (*this);
}
...
AudioParameterFloat* ATKGuitarPreampAudioProcessor::get_gain_parameter()
{
  return gain;
}

AudioParameterFloat* ATKGuitarPreampAudioProcessor::get_tone_stack_bass_parameter()
{
  return bass;
}

AudioParameterFloat* ATKGuitarPreampAudioProcessor::get_tone_stack_medium_parameter()
{
  return medium;
}

AudioParameterFloat* ATKGuitarPreampAudioProcessor::get_tone_stack_high_parameter()
{
  return high;
}

AudioParameterFloat* ATKGuitarPreampAudioProcessor::get_volume_parameter()
{
  return volume;
}

AudioParameterFloat* ATKGuitarPreampAudioProcessor::get_dry_wet_parameter()
{
  return drywet;
}
