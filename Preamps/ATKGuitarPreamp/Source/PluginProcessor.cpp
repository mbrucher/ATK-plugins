...
#endif
inFilter(nullptr, 1, 0, false), overdriveFilter(ATK::Triode2Filter<float, ATK::DempwolfTriodeFunction<float>>::build_standard_filter(220e3, 68e3, 1e6, 1.5e3, 300, 47e-9, 22e-6)), toneFilter(ATK::ToneStackCoefficients<float>::buildJCM800Stack()), outFilter(nullptr, 1, 0, false), parameters(*this, nullptr)
...
{  
  ...
  parameters.state = ValueTree (Identifier ("ATKGuitarPreamp"));;
