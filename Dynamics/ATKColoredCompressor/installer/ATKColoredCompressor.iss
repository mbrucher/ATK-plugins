...
[Files]
;Source: "..\Builds\VisualStudio2017\Win32\Release\Standalone Plugin\ATKColoredCompressor.exe"; DestDir: "{app}"; Check: not Is64BitInstallMode; Components:app; Flags: ignoreversion;
;Source: "..\Builds\VisualStudio2017\x64\Release\Standalone Plugin\ATKColoredCompressor x64.exe"; DestDir: "{app}"; Check: Is64BitInstallMode; Components:app; Flags: ignoreversion;

Source: "..\Builds\VisualStudio2017\Win32\Release\VST\ATKColoredCompressor.dll"; DestDir: {code:GetVST2Dir_32}; Components:vst2_32; Flags: ignoreversion;
Source: "..\Builds\VisualStudio2017\x64\Release\VST\ATKColoredCompressor x64.dll"; DestDir: {code:GetVST2Dir_64}; Check: Is64BitInstallMode; Components:vst2_64; Flags: ignoreversion;

Source: "..\Builds\VisualStudio2017\Win32\Release\VST3\ATKColoredCompressor.vst3"; DestDir: "{cf}\VST3\"; Check: not Is64BitInstallMode; Components:vst3_32; Flags: ignoreversion;
Source: "..\Builds\VisualStudio2017\Win32\Release\VST3\ATKColoredCompressor.vst3"; DestDir: "{cf32}\VST3\"; Check: Is64BitInstallMode; Components:vst3_32; Flags: ignoreversion;
Source: "..\Builds\VisualStudio2017\x64\Release\VST3\ATKColoredCompressor x64.vst3"; DestDir: "{cf64}\VST3\"; Check: Is64BitInstallMode; Components:vst3_64; Flags: ignoreversion;

;Source: "..\Builds\VisualStudio2017\Win32\Release\rtas\ATKColoredCompressor.dpm"; DestDir: "{cf32}\Digidesign\DAE\Plug-Ins\"; Components:rtas_32; Flags: ignoreversion;
;Source: "..\Builds\VisualStudio2017\Win32\Release\rtas\ATKColoredCompressor.dpm.rsr"; DestDir: "{cf32}\Digidesign\DAE\Plug-Ins\"; Components:rtas_32; Flags: ignoreversion;
...
Source: "..\Builds\VisualStudio2017\x64\Release\aax\ATKColoredCompressor.aaxplugin\*.*"; DestDir: "{cf}\Avid\Audio\Plug-Ins\ATKColoredCompressor.aaxplugin\"; Components:aax_64; Flags: ignoreversion recursesubdirs;
...
;Name: "{group}\User guide"; Filename: "{app}\ATKColoredCompressor_manual.pdf"
