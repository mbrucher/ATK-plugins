...
/**
*/
class ATKColoredCompressorAudioProcessor  : public AudioProcessor
{
public:
  //==============================================================================
  ATKColoredCompressorAudioProcessor();
  ~ATKColoredCompressorAudioProcessor();
...
private:
  //==============================================================================
  JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ATKColoredCompressorAudioProcessor)
