...
: AudioProcessorEditor (&p), processor (p), paramState(paramState), power(paramState, "power"), attackrelease(paramState, "attack", "release"), compressor(paramState, "threshold", -40, 0, "slope", 1.5, 100, "softness", -4, 0, "color", -.5, .5, "quality", 0.01, .2), makeup(paramState, "makeup", "Make-up", 0, 40), drywet(paramState, "drywet")
