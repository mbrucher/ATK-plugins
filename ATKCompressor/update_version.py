...
def main():
  ...
  plistpath = scriptpath + "/resources/ATKCompressor-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ATKCompressor-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ATKCompressor-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ATKCompressor-OSXAPP-Info.plist"
...
#  plistpath = scriptpath + "/resources/ATKCompressor-RTAS-Info.plist"
...
#  plistpath = scriptpath + "/resources/ATKCompressor-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/ATKCompressor-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/ATKCompressor.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/ATKCompressor.iss",inplace=1):
