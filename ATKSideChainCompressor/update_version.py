...
def main():
  ...
  plistpath = scriptpath + "/resources/ATKSideChainCompressor-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ATKSideChainCompressor-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ATKSideChainCompressor-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ATKSideChainCompressor-OSXAPP-Info.plist"
...
#  plistpath = scriptpath + "/resources/ATKSideChainCompressor-RTAS-Info.plist"
...
#  plistpath = scriptpath + "/resources/ATKSideChainCompressor-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/ATKSideChainCompressor-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  for line in fileinput.input(scriptpath + "/installer/ATKSideChainCompressor.iss",inplace=1):
