...
def main():
  ...
  plistpath = scriptpath + "/resources/ATKUniversalVariableDelay-VST2-Info.plist"
  print(plistpath)
  ...
  plistpath = scriptpath + "/resources/ATKUniversalVariableDelay-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ATKUniversalVariableDelay-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ATKUniversalVariableDelay-OSXAPP-Info.plist"
...
#  plistpath = scriptpath + "/resources/ATKUniversalVariableDelay-RTAS-Info.plist"
...
#  replacestrs(plistpath, "//Apple//", "//Apple Computer//");
#  
#  plistpath = scriptpath + "/resources/ATKUniversalVariableDelay-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/ATKUniversalVariableDelay-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/ATKUniversalVariableDelay.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/ATKUniversalVariableDelay.iss",inplace=1):
