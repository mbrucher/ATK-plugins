...
def main():
  ...
  plistpath = scriptpath + "/resources/ATKSD1-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ATKSD1-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ATKSD1-OSXAPP-Info.plist"
