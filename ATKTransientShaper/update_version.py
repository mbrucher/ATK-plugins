...
def main():
  ...
  plistpath = scriptpath + "/resources/ATKTransientShaper-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ATKTransientShaper-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ATKTransientShaper-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ATKTransientShaper-OSXAPP-Info.plist"
...
#  plistpath = scriptpath + "/resources/ATKTransientShaper-RTAS-Info.plist"
...
#  plistpath = scriptpath + "/resources/ATKTransientShaper-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/ATKTransientShaper-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/ATKTransientShaper.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/ATKTransientShaper.iss",inplace=1):
