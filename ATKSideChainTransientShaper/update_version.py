...
def main():
  ...
  plistpath = scriptpath + "/resources/ATKSideChainTransientShaper-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ATKSideChainTransientShaper-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ATKSideChainTransientShaper-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ATKSideChainTransientShaper-OSXAPP-Info.plist"
...
#  plistpath = scriptpath + "/resources/ATKSideChainTransientShaper-RTAS-Info.plist"
...
#  plistpath = scriptpath + "/resources/ATKSideChainTransientShaper-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/ATKSideChainTransientShaper-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/ATKSideChainTransientShaper.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/ATKSideChainTransientShaper.iss",inplace=1):
