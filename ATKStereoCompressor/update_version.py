...
def main():
  ...
  plistpath = scriptpath + "/resources/ATKStereoCompressor-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ATKStereoCompressor-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ATKStereoCompressor-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ATKStereoCompressor-OSXAPP-Info.plist"
...
#  plistpath = scriptpath + "/resources/ATKStereoCompressor-RTAS-Info.plist"
...
#  plistpath = scriptpath + "/resources/ATKStereoCompressor-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/ATKStereoCompressor-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/ATKStereoCompressor.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/ATKStereoCompressor.iss",inplace=1):
