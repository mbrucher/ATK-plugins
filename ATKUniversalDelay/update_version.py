...
def main():
  ...
  plistpath = scriptpath + "/resources/ATKUniversalDelay-VST2-Info.plist"
  print(plistpath)
  ...
  plistpath = scriptpath + "/resources/ATKUniversalDelay-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ATKUniversalDelay-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ATKUniversalDelay-OSXAPP-Info.plist"
...
#  plistpath = scriptpath + "/resources/ATKUniversalDelay-RTAS-Info.plist"
...
#  replacestrs(plistpath, "//Apple//", "//Apple Computer//");
#  
#  plistpath = scriptpath + "/resources/ATKUniversalDelay-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/ATKUniversalDelay-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/ATKUniversalDelay.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/ATKUniversalDelay.iss",inplace=1):
